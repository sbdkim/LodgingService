		...
		<article style="display: block; justify-content: center; text-align: center">
			...
			<form name="formm" id="book_form" method="post"	action="booking_insert" style="display: block">
				...
				<table id="accRoom" align="center" border="1" width="1000">
					<tr>
						<td rowspan="9" width="225">
							<c:choose>
								...
								<c:when test="${empty accRoom.rimage}">
									<img src="room_images/default.jpg" />
								</c:when>
								
								<c:otherwise>
									<img src="room_images/${accRoom.rimage}" />
								</c:otherwise>
					...
					<tr>
						<td><b>수용 인원</b></td>
						<td>${accRoom.maxcap}</td>
					</tr>
					<tr>
						<td><b>1박 가격</b></td>
						<td><input type="hidden" id="price" name="price" readonly value="${accRoom.price}"> ${accRoom.price}</td>
					</tr>
					<tr>
						<td><b>체크인</b></td>
