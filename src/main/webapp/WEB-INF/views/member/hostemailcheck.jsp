...
function hostemailok(){
	opener.document.getElementById("hemail").value="${hemail}";
	opener.document.getElementById("rehemail").value="${hemail}";
 	self.close();
}
</script>
</head>
...
<div id="wrap">
  ...
  <form method="post" name="formm" id="theform" style="margin-right:0 "
    ...
    Host EMAIL <input type="text" name="hemail" value="${hemail}"> 
            <input type="submit" value="검색" class="submit"><br>     
    <div style="margin-top: 20px">   
      <c:if test="${message == 1}">
        <script type="text/javascript">
          opener.document.formm.hemail.value="";
        </script>
