...
<header>
<div id="logo">
	<img class="header-image" id="header-image" alt="logo" src="css/KozyNestLogo4.jpg" style="width: 200px; float: left; padding: 5px;" onclick="location.href='index.html'">
</div>
	...
	<ul>
		<c:choose>
			...
			<c:when test="${not empty sessionScope.loginHost}">
				...
				<li><a href="host_mypage">${sessionScope.loginHost.name}님(마이페이지)</a></li>
			</c:when>
			
			<c:otherwise>
				<li><a href="logout">로그아웃</a></li>
				<li><a href="mypage">${sessionScope.loginUser.name}님(마이페이지)</a></li>
			</c:otherwise>
