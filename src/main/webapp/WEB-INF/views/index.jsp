	...
	<div class="alignform" style="padding-top: 10px; height: 100%; align-items: center;">
		...
		<form action="acc_search_list" name="f" method="get" style="margin-top: 20px;">
			<div class=search_room
				style="padding-top: 10px; height: 50%; align-items: center;">
				<!-- searchbox start-->
				<div style="margin-right: 10px; display: inline-block">
					<input type=search class=main_search_text placeholder=서울,서초구 name="key" id="key">
				</div>
				...
				<div class=main_count_box style="display: inline-block">
					<div role="button">
						...
						<!-- select 저장용 -->
						<select id="select_ro_count" class="form-select form-select-lg" onchange="change_ro_count()" style="border: none; height: 40px; width: 60px; border-radius: 5px; text-align: center">
